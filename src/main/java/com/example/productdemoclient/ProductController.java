...
import com.example.productdemoclient.service.InventoryService;
...
public class ProductController {
    ...
    public String getProduct(
        ...
        if(productId != null && !productId.equals("")) {
            ...
            model.addAttribute("inventory", inventoryService.getProductInventoryById(Integer.parseInt(productId)));
        }
        return "index";
    }
}
